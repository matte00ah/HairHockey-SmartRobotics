...
class MontecarloFilter:
    def __init__(self,robot, N=2500, dt=0.5, f=0.01, process_noise_std=0.5, measurement_noise_std=0.05, velocity_noise_std=0.3):
        self.N = N
        self.dt = dt
        self.f = f
    ...
    def save_filter_state(self, filename="./scene/scripts/filter_state.pkl"): # Se lanci da cmd: "./src/scene/scripts/filter_state.pkl"
        state = {
